...
LDFLAGS +=  $(fpic) $(SHARED) vendor/sdl-libretro/libSDL_gfx_$(SDL_PREFIX).a  vendor/sdl-libretro/libSDL_$(SDL_PREFIX).a -lpthread $(EXTRA_LDF) 
FLAGS += -I. -Ivendor/sdl-libretro/include -Ivendor/libretro-common/include
